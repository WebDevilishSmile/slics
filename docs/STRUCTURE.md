...
Keep: `android-chrome-192x192.png`, `android-chrome-512x512.png` (referenced by
`app/manifest.js`), `bmc-brand-logo.svg`, `slics-logo.png`, `slics_logo_dark.png`.
...
- [ ] **Files:** `app/android-chrome-192x192.png`, `app/android-chrome-512x512.png`,
...
- [ ] **Files:** `app/site.webmanifest`, `public/site.webmanifest`
